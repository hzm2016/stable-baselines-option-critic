...
from stable_baselines.ppoc import mlp_policy, pposgd_simple
import sys
...
def main():
    ...
    parser.add_argument('--env', help='environment ID', default='RoboschoolWalker2d-v1')
